// Test another knowledge base query with Cloudflare AutoRAG
...
// Query about authentication from previous successful tests
const query = 'Розкажи про авторизацію в API Checkbox';
